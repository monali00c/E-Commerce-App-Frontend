...
const Navbar = () => {
  ...
  return (
   ...
   <div className='flex items-center gap-6'>
      <img onClick={()=>setShowSearchBar(true)} src={assets.search_icon} alt="search" className='w-5 cursor-pointer'/>

      <div className='group relative'>
        <Link to='/MyProfile'><img src={assets.profile_icon} alt="profile" className='w-5 cursor-pointer'/></Link>
